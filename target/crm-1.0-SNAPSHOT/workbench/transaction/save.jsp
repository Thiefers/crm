	...
	<form action="workbench/transaction/save.do" id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="activityId" value="558b5081345c4710a103cadc94486009"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<%--此处暂时写死--%>
				<input type="text" class="form-control" id="create-contactsName" value="Roc">
				<input type="hidden" name="contactsId" value="70899dd95f5f47b5ae1954cbf665c555"/>
			</div>
		</div>
