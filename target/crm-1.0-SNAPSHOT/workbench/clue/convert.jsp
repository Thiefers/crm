...
<head>
	...
	<script type="text/javascript">
		$(function(){
			...
			// 为搜索操作模态窗口的 搜索框 绑定事件，执行搜索并展现市场活动列表的操作
					...
					$.ajax({
						...
						success : function (data){
							...
							$.each(data,function (i,n){
								html += '<tr>';
								html += '<td><input type="radio" name="checkOne" value="'+n.id+'"/></td>';
			...
			// 为 提交（市场活动） 按钮绑定事件，填充市场活动源（填写两项：名字+id）
...
<%--		    <label for="activity">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);" data-toggle="modal" data-target="#searchActivityModal" style="text-decoration: none;"><span class="glyphicon glyphicon-search"></span></a></label>--%>
				...
				<input type="hidden" id="activityId" name="actvityId" />
			</div>
		</form>
