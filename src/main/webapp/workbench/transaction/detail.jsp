...
<%@ page import="com.roc.crm.settings.domain.DicValue" %>
<%@ page import="java.util.Map" %>
<%@ page import="java.util.Set" %>
<%@ page import="com.roc.crm.workbench.domain.Tran" %>
...
<head>
	...
	<script type="text/javascript">
		...
		function changeIcon(stage,index0) {
			// 当前阶段
			...
			alert(index);
			alert(point);*/
			if (currentPossibility=="0") { // 如果当前阶段的可能性为0 前7个一定是黑圈，后两个一个是红叉，一个是黑叉
				// 遍历前7个
				for (var i = 0; i < point; i++) {
					...
					$("#"+i).removeClass();
					// 添加新样式
					$("#"+i).addClass("glyphicon glyphicon-record mtstage")
					// 为新样式赋予颜色
					$("#"+i).css("color","#000000");
				}
				// 遍历后两个
				for (var i = point; i < <%=dvList.size()%>; i++) {
					if (i==index) { // 如果是当前阶段
						// 红叉-----------------------------
						$("#"+i).removeClass();
						$("#"+i).addClass("glyphicon glyphicon-remove mtstage")
						$("#"+i).css("color","#FF0000");
					} else { // 如果不是当前阶段
						// 黑叉----------------------------
						$("#"+i).removeClass();
				...
				for (var i = 0; i < point; i++) {
					if (i == index) { // 如果是当前阶段
						// 绿色标记--------------------------
						$("#"+i).removeClass();
						$("#"+i).addClass("glyphicon glyphicon-map-marker mtstage")
						$("#"+i).css("color","#90F790");
					} else if (i < index) { // 如果小于当前阶段
						// 绿圈------------------------------
						$("#"+i).removeClass();
						$("#"+i).addClass("glyphicon glyphicon-ok-circle mtstage")
						$("#"+i).css("color","#90F790");
					} else { // 如果大于当前阶段
						// 黑圈-------------------------------
						$("#"+i).removeClass();
